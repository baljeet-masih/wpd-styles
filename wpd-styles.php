...
require_once plugin_dir_path( __FILE__ ) . 'includes/helper_functions.php';
...
function wpd_styles_modal_scripts() {
	...
	wp_enqueue_style( 'wpd-styles-magnific-popup', plugins_url('public/css/magnific-popup.css', __FILE__),'','1.3.0' );
	wp_enqueue_style( 'wpd-styles-main', plugins_url('public/css/main.css', __FILE__),'','1.3.0' );

	wp_enqueue_script( 'wpd-styles-fancybox', plugins_url( 'public/js/jquery.fancybox.min.js', __FILE__ ), array( 'jquery' ), '3.1.6', true );
	wp_enqueue_script( 'wpd-styles-magnific-popup', plugins_url('public/js/jquery.magnific-popup.min.js', __FILE__),array('jquery'),'1.3.0', false );
	wp_enqueue_script( 'wpb-styles-plugin-main', plugins_url('public/js/main.js', __FILE__),array('jquery'),'1.3.0', true );
}
